...
const ctx = canvas.getContext('2d');
 ...
 let ramal = Math.floor((Math.random() * ramalcim.length));
  ...
  ////////////////bitiş////////////////////////////////////////////////  
      const avatar = await Canvas.loadImage(`https://cdn.discordapp.com/avatars/${interaction.user.id}/${interaction.user.avatar}.png`);
 ctx.save();
