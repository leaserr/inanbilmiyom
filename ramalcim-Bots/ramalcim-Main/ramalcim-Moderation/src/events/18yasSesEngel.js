...
const member = client.guilds.cache.get(ramalcim.GuildID).members.cache.get(oldState.id);
const xd = await client.guilds.cache.get(ramalcim.GuildID).channels.cache.find(x => x.name.includes("+18"))?.id
