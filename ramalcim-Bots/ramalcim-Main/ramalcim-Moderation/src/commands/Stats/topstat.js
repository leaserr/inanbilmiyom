...
const db = require("../../../../../../Global/schemas/inviter");
  ...
  if (!message.member.permissions.has(PermissionsBitField.Flags.Administrator) && !kanallar.includes(message.channel.name)) return message.reply({ content: `${kanallar.map(x => `${client.channels.cache.find(chan => chan.name == x)}`)} kanallarında kullanabilirsiniz.`}).then((e) => setTimeout(() => { e.delete(); }, 10000)); 
    ...
    .addComponents(
        new StringSelectMenuBuilder()
            ...
            .addOptions([
                { label: 'Sunucunun En İyileri', description: 'En iyi istatistiğine sahip üyeler', value: 'top1', emoji: '1125417563485114368' },
                { label: 'Genel Ses Sıralaması', description: 'Tüm zamanların 20 genel ses sıralaması', value: 'top2', emoji: '1125417563485114368' },
                { label: 'Haftalık Ses Sıralaması', description: 'Bu haftanın 20 ses sıralaması', value: 'top3', emoji: '1125417563485114368' },
                { label: 'Genel Mesaj Sıralaması', description: 'Tüm zamanların 20 genel mesaj sıralaması', value: 'top4', emoji: '1125417563485114368' },
                { label: 'Haftalık Mesaj Sıralaması', description: 'Bu haftanın 20 mesaj sıralaması', value: 'top5', emoji: '1125417563485114368' },
                { label: 'Genel Yetkili Sıralaması', description: 'Tüm zamanların yetkili sıralaması', value: 'top6', emoji: '1125417563485114368' },
                { label: 'Genel Zengin Sıralaması', description: 'Tüm zamanların zengin sıralaması', value: 'top7', emoji: '1125417563485114368' },
                { label: 'Genel Davet Sıralaması', description: 'Tüm zamanların davet sıralaması', value: 'top8', emoji: '1125417563485114368' },
                { label: 'Genel Kayıt Sıralaması', description: 'Tüm zamanların kayıt sıralaması', value: 'top9', emoji: '1125417563485114368' },
            ]),
    );
...
.setDescription(`
${ramal_Yes} Aşağıda **${message.guild.name}** sunucusunun en iyileri sıralanmaktadır.
...
const embeds = new EmbedBuilder()
.setDescription(`
${ramal_Yes}  Aşağıda **${message.guild.name}** sunucusunun genel sohbet( \`ses\` ) sıralaması listelenmektedir.
...
const embeds = new EmbedBuilder()
.setDescription(`
${ramal_Yes}  Aşağıda **${message.guild.name}** sunucusunun bu haftanın sohbet( \`ses\` ) sıralaması listelenmektedir.
...
const embeds = new EmbedBuilder()
.setDescription(`
${ramal_Yes} Aşağıda **${message.guild.name}** sunucusunun genel sohbet( \`mesaj\` ) sıralaması listelenmektedir.
...
const embeds = new EmbedBuilder()
.setDescription(`
${ramal_Yes}  Aşağıda **${message.guild.name}** sunucusunun bu haftanın sohbet( \`mesaj\` ) sıralaması listelenmektedir.
...
const embeds = new EmbedBuilder()
.setDescription(`
${ramal_Yes}  Aşağıda **${message.guild.name}** sunucusunun genel yetkili sıralaması listelenmektedir.
...
const embeds = new EmbedBuilder()
.setDescription(`
${ramal_Yes} Aşağıda **${message.guild.name}** sunucusunun genel zengin sıralaması listelenmektedir.
...
const embeds = new EmbedBuilder()
.setDescription(`
${ramal_Yes}  Aşağıda **${message.guild.name}** sunucusunun genel davet sıralaması listelenmektedir.
...
const embeds = new EmbedBuilder()
.setDescription(`
${ramal_Yes}  Aşağıda **${message.guild.name}** sunucusunun genel kayıt sıralaması listelenmektedir.
