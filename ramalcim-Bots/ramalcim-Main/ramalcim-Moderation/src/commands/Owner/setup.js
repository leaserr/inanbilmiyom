...
const setup3 = [
  ...
  { name: ["public"], conf: "pub", cmdName: "public sorumlusu" },
  { name: ["invite"], conf: "invite", cmdName: "invite sorumlusu" },
  { name: ["streamers"], conf: "streamers", cmdName: "Streamer sorumlusu" },
  { name: ["chats"], conf: "chatsorumlu", cmdName: "chatsorumlusu" },
  { name: ["teyitt"], conf: "teyits", cmdName: "teyit sorumlusu" },
...
const setup6 = [
  ...
  { name: ["Sleep"], conf: "SleepsRoom", cmdName: "Afk Kategorisi" },
