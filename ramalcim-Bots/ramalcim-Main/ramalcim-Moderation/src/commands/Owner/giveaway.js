...
const giveaway = require('../../../../../../Global/schemas/giveaway')
const { ramal_Yes, red, cekilis } = require("../../../../src/configs/emojis.json")
...
`)], components: []
    ...
    collector.on("collect", async (button) => {
      ...
      if (button.customId == "katil") {
        ...
        let ramalcim = tikdata?.katilan.length + 1 || 1
        xd.setLabel(`${ramalcim}`)
