...
if (!uye) return message.reply({ content:` • Örnek; !perm @favel/ID`});
...
collector.on("collect", async (interaction) => {
     ...
     if (interaction.values[0] === "vip") {
        ...
        if(!uye.roles.cache.has(ayar.vipRole)) {
          ...
          msg.edit({ content:`${ramal_Yes} Başarıyla ${uye}, isimli kişiye **Vip** rolü verildi.`, components: [] });
        } else {
          ...
          msg.edit({ content:`${ramal_Yes} Başarıyla ${uye}, isimli kişinin **Vip** rolü geri alındı.`, components: [] });
        };
     }
    ...
    if (interaction.values[0] === "streamer") {
     ...
     if (interaction.values[0] === "terapi") {
      ...
      if(!uye.roles.cache.has(ayar.terapistRole)) {
        ...
        msg.edit({ content:`${ramal_Yes} Başarıyla ${uye}, isimli kişiye **Terapist** rolü verildi.`, components: [] });
      } else {
        ...
        msg.edit({ content:`${ramal_Yes} Başarıyla ${uye}, isimli kişinin **Terapist** rolü geri alındı.`, components: [] });
      };
   }
    ...
    if (interaction.values[0] === "sorun") {
        ...
        if(!uye.roles.cache.has(ayar.sorunçözücüRole)) {
          ...
          msg.edit({ content:`${ramal_Yes} Başarıyla ${uye}, isimli kişiye **Sorun Çözücü** rolü verildi.`, components: [] });
        } else {
          ...
          msg.edit({ content:`${ramal_Yes} Başarıyla ${uye}, isimli kişinin **Sorun Çözücü** rolü geri alındı.`, components: [] });
        };
     }
    })
