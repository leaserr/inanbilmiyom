...
const ayar = require("../../../../src/configs/Yetki.json");
...
Bot-Owner: (${ramalcim.owners.length > 0 ? `${ramalcim.owners.map(x => `<@${x}>`).join(",")}` : "\`YOK\`"})
...
const setup2 = [
  ...
  { name: ["muzisyen"], conf: "müzisyen", cmdName: "Yetkili Rol(leri)" },
  { name: ["sponsor"], conf: "sponsorr", cmdName: "Yetkili Rol(leri)" },
  { name: ["tasarimci"], conf: "tasarimci", cmdName: "Yetkili Rol(leri)" },
  { name: ["kamera"], conf: "kameraa", cmdName: "Yetkili Rol(leri)" },
  { name: ["st","streamer"], conf: "streamer", cmdName: "Yetkili Rol(leri)" },
  { name: ["vip"], conf: "vipp", cmdName: "Yetkili Rol(leri)" },
  { name: ["yt1"], conf: "yetki1", cmdName: "Yetkili Rol(leri)" },
  { name: ["yt2"], conf: "yetki2", cmdName: "Yetkili Rol(leri)" },
  { name: ["yt3"], conf: "yetki3", cmdName: "Yetkili Rol(leri)" },
  { name: ["yt4"], conf: "yetki4", cmdName: "Yetkili Rol(leri)" },
  { name: ["yt5"], conf: "yetki5", cmdName: "Yetkili Rol(leri)" },
  { name: ["yt6"], conf: "yetki6", cmdName: "Yetkili Rol(leri)" },
  { name: ["yt7"], conf: "yetki7", cmdName: "Yetkili Rol(leri)" },
  { name: ["yt8"], conf: "yetki8", cmdName: "Yetkili Rol(leri)" },
  { name: ["yt9"], conf: "yetki9", cmdName: "Yetkili Rol(leri)" },
  { name: ["yt10"], conf: "yetki10", cmdName: "Yetkili Rol(leri)" },
...
setup1.forEach(async (x) => {
  ...
  return }
  global.ramalsetupxd.set(`${x.conf}`, `${select}`)
...
xxx.on("collect", async (interaction) => {
  ...
  if(interaction.customId === "test") {
    ...
    global.ramalsetupxd.set(`${x.conf}`, xd)
...
xxx.on("collect", async (interaction) => {
  ...
  if(interaction.customId === "test2") {
    await interaction.deferUpdate();
    if(rol) {
    global.ramalsetupxd.set(`${x.conf}`, `${rol}`)
...
setup4.forEach(async (x) => {
  ...
  xxx.on("collect", async (interaction) => {
    ...
    if(interaction.customId === "test3") {
      await interaction.deferUpdate();
      if(channel) {
      global.ramalsetupxd.set(`${x.conf}`, `${channel}`)
