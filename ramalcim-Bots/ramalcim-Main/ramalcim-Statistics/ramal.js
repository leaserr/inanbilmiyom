...
client
  .login(ramalcim.Main.StatsToken)
...
////
let stats = require("../src/../../../Global/schemas/level");
...
client.checkLevel = async function (userID, guildID, type) {
  if (ramalcim.Main.LevelSystem == false) return;
  ...
  let member = client.guilds.cache.get(ramalcim.GuildID).members.cache.get(userID)
